...
public class ImpresarioCreateRequest {
        ...
        public ImpresarioCreateRequest() {
        }

        public ImpresarioCreateRequest(String firstName, String lastName, String organization, String contactInfo) {
