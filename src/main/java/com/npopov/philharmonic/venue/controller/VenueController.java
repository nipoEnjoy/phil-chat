package com.npopov.philharmonic.venue.controller;

import com.npopov.philharmonic.venue.dto.VenueCreateRequest;
import com.npopov.philharmonic.venue.dto.VenueMapper;
...
import com.npopov.philharmonic.venue.dto.VenueUpdateRequest;
...
public class VenueController {
    ...
    public List<VenueResponse> getAll(@RequestParam(required = false) VenueType type) {
        List<Venue> list = type == null ? venueService.findAll() : venueService.findByVenueType(type);
