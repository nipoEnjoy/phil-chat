...
public class Theatre extends Venue {
    ...
    public Theatre(String name, VenueType venueType, String address, String city, String description, Integer capacity, Integer stageWidthMm, Integer stageDepthMm) {
